...
public class TestStudent {
	...
	public void testSetAgeConformanceForRightInput() {
		...
		try {
			...
			fail("We got exception for right data");
		}
	}
...
//		}
		...
		assertEquals("Testing with sorted array of grades", expectedAverage, computedAverage, 0.004);
	...
	public void testGetGradesAverageCardinalityZero() throws WrongGradeException {
		...
		assertEquals("Testing with an empty array", expectedAverage, computedAverage, 0);
	...
	@Test
	public void testGetGradesAverageExistenceNullReferennceForGrades() throws WrongGradeException {
